...
def round_trip_sentence(generator, sentence):
    ...
    chinese_sentence = ask_llama(
        generator,
        f"Translate this English sentence to Chinese: {sentence}",
    )

    back_to_english = ask_llama(
        generator,
        f"Translate this Chinese sentence to English: {chinese_sentence}",
    )

    return chinese_sentence, back_to_english
...
def score_sentence_words(row, generator, fuzzy_threshold, nlp):
    ...
    # Machine translation
    chinese_sentence, back_to_english = round_trip_sentence(generator, sentence)
    ...
    translated_word_set = normalized_word_set(chinese_sentence)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Detect slang candidates using full-sentence English-Chinese-English round-trip translation."
    )
