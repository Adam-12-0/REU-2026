...
def round_trip_sentence(generator, sentence):
    ...
    arabic_sentence = ask_llama(
        generator,
        f"Translate this English sentence to Arabic: {sentence}",
    )

    back_to_english = ask_llama(
        generator,
        f"Translate this Arabic sentence to English: {arabic_sentence}",
    )

    return arabic_sentence, back_to_english
...
def score_sentence_words(row, generator, fuzzy_threshold, nlp):
    ...
    # Machine translation
    arabic_sentence, back_to_english = round_trip_sentence(generator, sentence)
    ...
    translated_word_set = normalized_word_set(arabic_sentence)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Detect slang candidates using full-sentence English-Arabic-English round-trip translation."
    )
